<script>
  ...
  const THRESHOLD_DESC =
    "How long one acquire parks on a full account lane's queue before spilling to the next account. Persisted as QUEUE_WAIT — the same row as the Queue Wait editor below.";
